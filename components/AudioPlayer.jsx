"use client";
import { loop, mute, pause, play, shuffle, switchVolumeScaleType, volume } from '@/lib/features/audio';
                ...
                <div className="rhap_controls-section">
                    ...
                    <div className="rhap_volume-controls">
                        <div className="rhap_volume-container">
                            <button onClick={() => dispatch(mute())} onContextMenu={() => dispatch(switchVolumeScaleType(audio.volumeScaleType === "linear" ? "logarithmic" : "linear"))} aria-label="Muting" type="button" className="rhap_button-clear rhap_volume-button">
                                {audio.muted ?
