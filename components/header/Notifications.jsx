...
export default function Notifications() {
    ...
    return (
        <div ref={clickOutside} id="top_notifications_btn" className={`top_btn ${open ? "active" : ""}`} onMouseDown={(e) => click(e)} >
            ...
            <div ref={dropdown}
                className={`top_dropdown notifications_dropdown ${open ? "show" : ""}`}>
