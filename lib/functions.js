        ...
        case "video": {
            ...
            return {
                ...
                openGraph: {
                    ...
                    url: "/video/" + video.id,
                    images: {
                        url: process.env.NEXT_PUBLIC_API + `video/thumbnail/${video.id}`,
                        secureUrl: process.env.NEXT_PUBLIC_API + `video/thumbnail/${video.id}`,
                    },
                    videos: {
...
export const staticMetadataExtractor = async (name, data) => {
    switch (name) {
        case "profile": {
            return {
