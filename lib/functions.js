            ...
            return {
                ...
                openGraph: {
                    ...
                    images: [{
                        ...
                        url: process.env.NEXT_PUBLIC_API + `photo/${data.id}`,
                        secureUrl: process.env.NEXT_PUBLIC_API + `photo/${data.id}`,
                        }]
                },
            }
        }
        case "audio": {
            return {
                ...
                openGraph: {
                    ...
                    type: "music.song",
                    url: "/audio/" + data.id,
                    audio: process.env.NEXT_PUBLIC_API + `audio/stream/${data.id}.mp3`,
                },
            }
        }
        default: {
