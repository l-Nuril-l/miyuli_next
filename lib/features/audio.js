...
export const getAudioInitialState = (isMobileDevice) => {
    var state = {
        audio: null,
        muted: false,
        loop: false,
        shuffle: false,
        volume: isMobileDevice ? 100 : 10,
        duration: 0,
        isPlaying: false,
        search: null,
...
const audiosSlice = createSlice({
    name: "audio",
    initialState: getAudioInitialState(),
    reducers: {
...
export const { clearAudioData, clearErrorAudios, clearPlaylistAudios, setDownloadProgress, clearPlaylist, showEditPlaylistModal, closeEditPlaylistModal, clearAttachAudios, clearAudios, pause, stop, play, audio, loop, shuffle, mute, volume } = audiosSlice.actions;
